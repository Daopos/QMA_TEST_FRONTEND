...
export default function OldStudentForm({
    ...
    const handleSubmit = () => {
        ...
        if (formValues.birth_certificate instanceof File) {
            formData.append("birth_certificate", formValues.birth_certificate);
        }
        if (formValues.report_card instanceof File) {
            formData.append("report_card", formValues.report_card);
        }
        if (formValues.transcript_record instanceof File) {
            formData.append("transcript_record", formValues.transcript_record);
        }
        if (formValues.good_moral instanceof File) {
            formData.append("good_moral", formValues.good_moral);
        }
